...
//builder.AddOpenTelemetryLog(); //Paketten patladýk bu yüzden buraya taþýdýk 
...
builder.Services.AddScoped<OrderService>(); // request response dönüþünceye akdar bu servisi kullnacayým response olduðunda dispose olsun scopped
...
{
    options.BaseAddress = new Uri((builder.Configuration.GetSection("ApiServices")["StockApi"])!); // Yalnýz stock service içi mi?
});
